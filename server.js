...
const a_admin_commentReport = require('./s-route/api/admin/comment-report')
const a_admin_comment = require('./s-route/api/admin/comment')
const a_admin_post = require('./s-route/api/admin/post')
const a_admin_user = require('./s-route/api/admin/user')
...
const p_activity = require('./s-route/pages/activity')
...
const p_user_activity = require('./s-route/pages/user/activity')
const p_user_activity_lookup = require('./s-route/pages/user/activity/lookup')
