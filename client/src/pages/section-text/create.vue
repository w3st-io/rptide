...
<script>
	...
	import SectionTextService from '@/services/user/SectionTextService'
	...
	export default {
		...
		methods: {
			...
			// [CREATE] Create Post Via SectionTextService Function //
			async postCreate() {
				try {
					this.disabled = true
					this.loading = true
					...
					this.reqData = await SectionTextService.s_create(
						this.title,
						this.cleanJSON
					)
